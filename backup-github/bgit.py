...
def retrieve_repositories(args, output_directory):
    ...
    all_repositories_file = '{0}/all_repositories.json'.format(output_directory)
    with codecs.open(all_repositories_file, 'w', encoding='utf-8') as f:
        json_dump(repos, f)
    return repos
...
def main():
    ...
    repositories = retrieve_repositories(args, output_directory)
